...
3. Keep ambiguous evidence labeled `report-only`; never describe correlation as ownership.
...
6. Keep platform-specific discovery behind `ProcessBackend`.

Do not add name-only, age-only, or duplicate-count-only attribution. Changes that
